#ifndef ob_proxy_parser_gbk_yyHEADER_H
#define ob_proxy_parser_gbk_yyHEADER_H 1
#define ob_proxy_parser_gbk_yyIN_HEADER 1

#line 6 "ob_proxy_parser_gbk_lex.h"

#line 8 "ob_proxy_parser_gbk_lex.h"
...
OBPROXYSTYPE * ob_proxy_parser_gbk_yyget_lval (yyscan_t yyscanner );

void ob_proxy_parser_gbk_yyset_lval (OBPROXYSTYPE * yylval_param ,yyscan_t yyscanner );

       OBPROXYLTYPE *ob_proxy_parser_gbk_yyget_lloc (yyscan_t yyscanner );
    
        void ob_proxy_parser_gbk_yyset_lloc (OBPROXYLTYPE * yylloc_param ,yyscan_t yyscanner );
...
#line 371 "ob_proxy_parser_gbk_lex.h"
