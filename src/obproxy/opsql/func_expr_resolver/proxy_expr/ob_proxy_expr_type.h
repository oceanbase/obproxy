...
typedef enum ObProxyExprType
{
  ...
  OB_PROXY_EXPR_TYPE_FUNC_YEAR,
  OB_PROXY_EXPR_TYPE_FUNC_MONTH,
...
const char* get_expr_type_name(int expr_type)
{
  ...
  switch(expr_type) {
    ...
    case OB_PROXY_EXPR_TYPE_FUNC_TO_DATE:
      ...
      break;
    case OB_PROXY_EXPR_TYPE_FUNC_YEAR:
      type_name = "OB_PROXY_EXPR_TYPE_FUNC_YEAR";
      break;
    case OB_PROXY_EXPR_TYPE_FUNC_MONTH:
      type_name = "OB_PROXY_EXPR_TYPE_FUNC_MONTH";
      break;
    ...
    case OB_PROXY_EXPR_TYPE_FUNC_TO_NUMBER:
      ...
      break;
    case OB_PROXY_EXPR_TYPE_FUNC_SUBSTR_INDEX:
      type_name = "OB_PROXY_EXPR_TYPE_FUNC_SUBSTR_INDEX";
      break;
    default:
      break;
  }
