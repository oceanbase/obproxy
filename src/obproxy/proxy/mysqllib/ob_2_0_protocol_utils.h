...
public:
  ...
  static int encode_empty_resultset(event::ObMIOBuffer &write_buf, Ob20HeaderParam &ob20_head_param,
                                    uint8_t &seq, const uint16_t status_flag = 0);
  ...
  static int analyze_one_ob20_packet_header(event::ObIOBufferReader &reader,
                                           ObAnalyzeHeaderResult &result,
