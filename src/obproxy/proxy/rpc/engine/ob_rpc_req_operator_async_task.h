 ...
 */
#ifndef OBPROXY_RPC_REQ_OB_PROXY_ASYNC_TASK_H
#define OBPROXY_RPC_REQ_OB_PROXY_ASYNC_TASK_H
...
class ObRpcReqOperatorAsyncCommonTask : public obutils::ObAsyncCommonTask
{
public:
  ObRpcReqOperatorAsyncCommonTask(int64_t target_task_count, ObProxyRpcReqOperator *ob_operator);
...
public:
  ...
  int64_t cont_index_;
  int64_t timeout_ms_;
  ObProxyRpcReqOperator *ob_rpc_operator_;
  DISALLOW_COPY_AND_ASSIGN(ObRpcReqOperatorAsyncCommonTask);
...
#endif /* OBPROXY_RPC_REQ_OB_PROXY_ASYNC_TASK_H */
