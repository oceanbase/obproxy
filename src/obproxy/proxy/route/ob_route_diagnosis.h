...
public:
  ...
  // OB_MYSQL_COM_QUERY/OB_MYSQL_COM_STMT_PREPARE_EXECUTE/OB_MYSQL_COM_STMT_PREPARE/OB_MYSQL_COM_STMT_SEND_PIECE_DATA/
  // OB_MYSQL_COM_STMT_GET_PIECE_DATA/OB_MYSQL_COM_STMT_FETCH/OB_MYSQL_COM_STMT_SEND_LONG_DATA
  inline void set_is_request_diagnostic(const ObProxyMysqlRequest &cli_req);
  // `explain route <sql>` not support
  // OB_MYSQL_COM_STMT_PREPARE/OB_MYSQL_COM_STMT_PREPARE_EXECUTE/OB_MYSQL_COM_STMT_CLOSE/
