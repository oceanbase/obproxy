...
#define PARTITION_ENTRY_LOOKUP_BATCH_REMOTE_EVENT                 (PARTITION_ENTRY_EVENT_EVENTS_START + 6)
#define PARTITION_ENTRY_FAIL_SCHEDULE_LOOKUP_BATCH_REMOTE_EVENT   (PARTITION_ENTRY_EVENT_EVENTS_START + 7)
#define PARTITION_ENTRY_LOOKUP_BATCH_RETRY_CLEAN                  (PARTITION_ENTRY_EVENT_EVENTS_START + 8)
#define PARTITION_ENTRY_LOOKUP_BATCH_REMOTE_PERIOD                (PARTITION_ENTRY_EVENT_EVENTS_START + 9) //not to use
#define PARTITION_ENTRY_LOOKUP_BATCH_TO_RELEASE                   (PARTITION_ENTRY_EVENT_EVENTS_START + 10) //not to use
