...
// Used for ObTableLSOp, it's different from deserialization of ObObj
/*
...
public:
  ...
  static int serialize(char *buf, const int64_t buf_len, int64_t &pos, const ObObj &obj);
  static int64_t get_serialize_size(const ObObj &obj);
  static int deserialize(const char *buf, const int64_t data_len, int64_t &pos, common::ObIAllocator *deserialize_allocator, ObNewRange &range);
  ...
  static int deserialize(const char *buf, const int64_t data_len, int64_t &pos, common::ObIAllocator *deserialize_allocator, ObRowkey &range);
