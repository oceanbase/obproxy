...
class EventTable
{
  public:
    ...
    enum {
      ...
      EN_SERVICE_NAME_RESET_FAIL = 29,
      EN_FAILOVER_MODE_RESET_FAIL = 30,
      EN_SERVICE_NAME_WRONG = 31,
      EN_RPC_NO_MASTER = 32,
      EN_RPC_SET_SHARD = 33,
      EN_RPC_CLIENT_NET_READ_TIMEOUT = 34,
      EN_RPC_CLIENT_NET_WRITE_TIMEOUT = 35,
      EVENT_TABLE_MAX,
    };
