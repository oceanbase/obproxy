...
namespace common
{
//Suppose there are multiple threads adding elements to the queue, but only one thread will fetch elements, and no two threads will add elements with the same number to the queue at the same time.
