...
MOD_ITEM_DEF(OB_PROXY_INDEX_ENTRY_MAP)
MOD_ITEM_DEF(OB_PROXY_TABLEGROUP_ENTRY_MAP)
MOD_ITEM_DEF(OB_PROXY_TABLET_LS_ENTRY_MAP)
MOD_ITEM_DEF(OB_PROXY_TABLET_LS_ID_MAP)
MOD_ITEM_DEF(OB_PROXY_RPC_TABLE_QUERY_MAP)
MOD_ITEM_DEF(OB_PROXY_RPC_REQ_CTX_MAP)
MOD_ITEM_DEF(OB_PROXY_RPC_REDIS_MONITOR_MAP)
...
MOD_ITEM_DEF(OB_PROXY_SHOW_TRACE_JSON)
MOD_ITEM_DEF(OB_PROXY_SESS_SYNC)
MOD_ITEM_DEF(OB_PROXY_READ_STALE_MAP)
MOD_ITEM_DEF(OB_PROXY_ROUTE_DIAGNOSIS_SE_ARRAY)
MOD_ITEM_DEF(OB_PROXY_ROUTE_DIAGNOSIS_STRING)
MOD_ITEM_DEF(OB_PROXY_PS_RELATED)
MOD_ITEM_DEF(OB_PROXY_RPC_PARSE)
MOD_ITEM_DEF(OB_PROXY_MEM_LEAK_CHECK)
MOD_ITEM_DEF(OB_PROXY_CLIENT_SESSION_ID)
MOD_ITEM_DEF(OB_PROXY_DECIMAL_INT_CONST)
MOD_ITEM_DEF(OB_PROXY_GLOBAL_PS)
MOD_ITEM_DEF(OB_PROXY_UNKNOWN_MOD)
...
// TABLE API
MOD_ITEM_DEF(OB_RPC_TABLE_PROC)
MOD_ITEM_DEF(OB_RPC_TABLE_BATCH_OPERATION)
MOD_ITEM_DEF(OB_RPC_TABLE_BATCH_OPERATION_RESULT)
MOD_ITEM_DEF(OB_RPC_TABLE_CLIENT)
MOD_ITEM_DEF(OB_RPC_TABLE_ENTITY)
MOD_ITEM_DEF(OB_RPC_TABLE_ROWKEY)

MOD_ITEM_DEF(OB_RPC_SHARED_REQUEST_BUF)

MOD_ITEM_DEF(OB_RPC_TABLE_IGNORE_FIELD)

MOD_ITEM_DEF(OB_RPC_TABLE_LS_OPERATION)
MOD_ITEM_DEF(OB_RPC_TABLE_LS_OPERATION_RESULT)
MOD_ITEM_DEF(OB_RPC_TABLE_QUERY)
MOD_ITEM_DEF(OB_RPC_TABLE_QUERY_RESULT)
MOD_ITEM_DEF(OB_RPC_TABLE_TABLE_OPERATION)
MOD_ITEM_DEF(OB_RPC_TABLE_TABLET_OPERATION)
MOD_ITEM_DEF(OB_RPC_TABLE_GROUP)
MOD_ITEM_DEF(OB_RPC_TABLE_REDIS)
MOD_ITEM_DEF(OB_RPC_HBASE_OPERATION)

// REDIS
MOD_ITEM_DEF(REDIS_CTX)
