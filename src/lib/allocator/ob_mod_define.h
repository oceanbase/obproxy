...
// TABLE API
MOD_ITEM_DEF(TABLE_PROC)
MOD_ITEM_DEF(TABLE_ENTITY)
MOD_ITEM_DEF(TABLE_CLIENT)
MOD_ITEM_DEF(TABLE_BATCH_OPERATION)
MOD_ITEM_DEF(TABLE_BATCH_OPERATION_RESULT)

MOD_ITEM_DEF(TABLE_LS_OPERATION)
MOD_ITEM_DEF(TABLE_LS_OPERATION_RESULT)
