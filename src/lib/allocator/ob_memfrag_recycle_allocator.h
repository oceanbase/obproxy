...
public:
  ...
  //NOT thread safe.
  //@param mod_id: the memory module id of this allocator
  ...
  virtual void set_mod_id(int64_t mod_id);
...
private:
  enum ObMemfragRecycleAllocatorState
  {
    INIT,
    SWITCHING_PREPARE,
    SWITCHING,
  ...
  static const double TOTAL_MEMORY_REWRITE_THRESHOLD_FACTOR = 1.1;
