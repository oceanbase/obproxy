...
static struct ObStrErrorInit
{
  ObStrErrorInit()
  {
    ...
    MYSQL_ERRNO[-OB_PROXY_SEND_LONG_DATA_PIECES_ERROR] = -1;
    SQLSTATE[-OB_PROXY_SEND_LONG_DATA_PIECES_ERROR] = "HY000";
    STR_ERROR[-OB_PROXY_SEND_LONG_DATA_PIECES_ERROR] = "Send long data pieces ERROR";
    STR_USER_ERROR[-OB_PROXY_SEND_LONG_DATA_PIECES_ERROR] = "Send long data pieces ERROR";
