...
static struct ObStrErrorInit
{
  ObStrErrorInit()
  {
    ...
    STR_ERROR[-OB_CLIENT_RECEIVING_PACKET_CONNECTION_ERROR] = "An EOS event received from client while obproxy reading request";
    STR_USER_ERROR[-OB_CLIENT_RECEIVING_PACKET_CONNECTION_ERROR] = "An EOS event received from client while obproxy reading request";
    MYSQL_ERRNO[-OB_CLIENT_HANDLING_RQUEST_CONNECITON_ERROR] = -1;
    SQLSTATE[-OB_CLIENT_HANDLING_RQUEST_CONNECITON_ERROR] = "HY000";
    STR_ERROR[-OB_CLIENT_HANDLING_RQUEST_CONNECITON_ERROR] = "An EOS event received from client while obproxy handling request";
    STR_USER_ERROR[-OB_CLIENT_HANDLING_RQUEST_CONNECITON_ERROR] = "An EOS event received from client while obproxy handling request";
    MYSQL_ERRNO[-OB_CLIENT_TRANSFERING_PACKET_CONNECTION_ERROR] = -1;
    SQLSTATE[-OB_CLIENT_TRANSFERING_PACKET_CONNECTION_ERROR] = "HY000";
    STR_ERROR[-OB_CLIENT_TRANSFERING_PACKET_CONNECTION_ERROR] = "An EOS event received from client while obproxy transfering request";
    STR_USER_ERROR[-OB_CLIENT_TRANSFERING_PACKET_CONNECTION_ERROR] = "An EOS event received from client while obproxy transfering request";
    ...
    STR_ERROR[-OB_SERVER_RECEIVING_PACKET_CONNECTION_ERROR] = "An EOS event received while proxy reading response";
    STR_USER_ERROR[-OB_SERVER_RECEIVING_PACKET_CONNECTION_ERROR] = "An EOS event received while proxy reading response";
    MYSQL_ERRNO[-OB_SERVER_CONNECT_TIMEOUT] = -1;
    SQLSTATE[-OB_SERVER_CONNECT_TIMEOUT] = "HY000";
    STR_ERROR[-OB_SERVER_CONNECT_TIMEOUT] = "An INACTIVITY_TIMEOUT event received while proxy reading response";
    STR_USER_ERROR[-OB_SERVER_CONNECT_TIMEOUT] = "An INACTIVITY_TIMEOUT event received while proxy reading response";
    MYSQL_ERRNO[-OB_SERVER_TRANSFERING_PACKET_CONNECTION_ERROR] = -1;
    SQLSTATE[-OB_SERVER_TRANSFERING_PACKET_CONNECTION_ERROR] = "HY000";
    STR_ERROR[-OB_SERVER_TRANSFERING_PACKET_CONNECTION_ERROR] = "An EOS event eceived while proxy transfering response";
    STR_USER_ERROR[-OB_SERVER_TRANSFERING_PACKET_CONNECTION_ERROR] = "An EOS event eceived while proxy transfering response";
    MYSQL_ERRNO[-OB_PLUGIN_TRANSFERING_ERROR] = -1;
    SQLSTATE[-OB_PLUGIN_TRANSFERING_ERROR] = "HY000";
    STR_ERROR[-OB_PLUGIN_TRANSFERING_ERROR] = "OBProxy plugin transfering failed";
    STR_USER_ERROR[-OB_PLUGIN_TRANSFERING_ERROR] = "OBProxy plugin transfering failed";
    ...
    STR_ERROR[-OB_PROXY_NO_NEED_RETRY] = "OBProxy reached the maximum number of retrying request";
    STR_USER_ERROR[-OB_PROXY_NO_NEED_RETRY] = "OBProxy reached the maximum number of retrying request";
    MYSQL_ERRNO[-OB_PROXY_CHECK_CLUSTER_VERSION_FAIL] = -1;
    SQLSTATE[-OB_PROXY_CHECK_CLUSTER_VERSION_FAIL] = "HY000";
    STR_ERROR[-OB_PROXY_CHECK_CLUSTER_VERSION_FAIL] = "Cluster resource version checked failed";
    STR_USER_ERROR[-OB_PROXY_CHECK_CLUSTER_VERSION_FAIL] = "Cluster resource version checked failed";
    MYSQL_ERRNO[-OB_PROXY_FETCH_RSLIST_FAIL] = -1;
    SQLSTATE[-OB_PROXY_FETCH_RSLIST_FAIL] = "HY000";
    STR_ERROR[-OB_PROXY_FETCH_RSLIST_FAIL] = "Cluster resource version checked failed";
    STR_USER_ERROR[-OB_PROXY_FETCH_RSLIST_FAIL] = "Cluster resource version checked failed";
    ...
    STR_ERROR[-OB_PROXY_RECONNECT_COORDINATOR] = "OBProxy inactivity timeout";
    STR_USER_ERROR[-OB_PROXY_RECONNECT_COORDINATOR] = "OBProxy inactivity timeout";
    MYSQL_ERRNO[-OB_PROXY_INVALID_COORDINATOR] = -1;
    SQLSTATE[-OB_PROXY_INVALID_COORDINATOR] = "HY000";
    STR_ERROR[-OB_PROXY_INVALID_COORDINATOR] = "OBProxy coordinator is invalid";
    STR_USER_ERROR[-OB_PROXY_INVALID_COORDINATOR] = "OBProxy coordinator is invalid";
