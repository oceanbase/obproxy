...
public:
  ...
  void set_nls_currency(const common::ObString &nls_currency, const common::ObString &nls_iso_currency, const common::ObString &nls_dual_currency);
  void set_iso_grouping(const common::ObString &nls_numeric_characters);
...
public:
  ObNFMToNumber() {}
  int convert_char_to_num(const common::ObString &nls_currency,
 ...
 private:
  int process_fmt_conv(const common::ObString &nls_currency,
                       const common::ObString &nls_iso_currency,
                       const common::ObString &nls_dual_currency,
                       const common::ObString &nls_numeric_characters,
                       const common::ObString &in_str,
