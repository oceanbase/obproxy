...
int OMPKPrepareExecute::serialize(char* buffer, int64_t length, int64_t& pos) const
{
  int ret = OB_SUCCESS;
...
int64_t OMPKPrepareExecute::get_serialize_size() const
{
  int64_t len = 0;
  len += 1;                 // status
  len += 4;                 // statement id
